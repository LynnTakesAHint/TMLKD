...
from geo_rnns.t3s_model import T3S_Network
...
class TMLKD_Trainer_T3S(object):
    ...
    def trained_model_eval(self, load_model=None):
        spatial_net = T3S_Network(target_size=self.target_size, batch_size=self.batch_size,
        ...
        if load_model is not None:
            ...
            embeddings = tm.test_comput_embeddings(
                self, spatial_net, test_batch=500, mode='test')
